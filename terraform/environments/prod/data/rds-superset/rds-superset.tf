...
terraform {
  ...
  backend "s3" {
    ...
    key    = "data/rds-superset/rds-superset"
    region = "us-east-1"
  }
}
...
data "aws_ssm_parameter" "username" {
  name = "/prod/rds-superset/USERNAME"
}

data "aws_ssm_parameter" "password" {
  name = "/prod/rds-superset/PASSWORD"
}

# TODO:  Lock down to superset service security group; protected from public access for now though
